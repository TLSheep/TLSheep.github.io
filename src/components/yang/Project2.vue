  ...
  <div class="P2">
    <div class="progress">
      <div class="progress_line_container">
        <div
          class="progress_line"
          :style="{
            width: (100 / progress_count) * current + '%',
      ...
      <div
        class="point"
        :style="{
          borderColor: current >= index - 1 ? props.line_color : '#E0E0E0',
        }"
    ...
    <div class="btn_group">
      <button
        class="btn"
        :disabled="current === 0"
        @click="current === 0 ? 0 : current--"
      >
        Prev
      </button>
      <button
        class="btn"
        :disabled="current === progress_count"
        @click="current === progress_count ? current : current++"
      >
        Next
      </button>
    </div>
