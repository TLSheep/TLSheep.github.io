    ...
    <div class="P3">
        <div class="container" :class="{'show_nav':show_nav}">
            <div class="circle_container">
                <div class="circle">
                    <button id="open" class="btn iconfont icon-liebiao" @click="show_nav = true"></button>
                    <button id="close" class="btn iconfont icon-guanbi" @click="show_nav = false"></button>
                </div>
            </div>
            <div class="content">
                ...
                <h3>My Photo</h3>
                <img style="max-width: 1000px;" src="/src/assets/imgs/5.jpeg">
        ...
        <div class="nav">
            <ul>
                <li>
                    <div class="iconfont icon-home"> HOME</div>
                 
                </li>
                <li>
                    <div class="iconfont icon-yonghu"> ABOUT</div>
                </li>
                <li>
                    <div class="iconfont icon-email-s"> CONTACT</div>
                </li>
            </ul>
        </div>
    </div>
